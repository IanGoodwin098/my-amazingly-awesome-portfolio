...
<main class="flex flex-col flex-1 p-4">
  ...
  >
    ...
    >
      <h2 class="font-semibold text-4xl sm:text-5xl md:text-6xl">
        Hi! im <span class="poppins text-violet-400">Ian</span> Goodwin
        <br />Full Stack
      ...
      <a
        href="https://www.linkedin.com/in/ian-goodwin-042b76289"
        target="_blank"
  ...
  <section id="projects" class="py-20 lg:py-32 flex flex-col gap-24">
    <div class="flex flex-col gap-2 text-center">
      <h4 class="text-lg sm:text-xl mg:text-2xl">
        A few of my creative endevors,
      </h4>
    ...
    <Step step={steps[0]}>
      <p>
        NextJS Pokedex is a
        <strong class="text-violet-400">NextJs and tailwind</strong> web
        application, hosted on <strong class="text-violet-400">Vercel</strong>,
        that consumes and caches the
        <strong class="text-violet-400">Pokemon API</strong> to display all pokemon
    ...
    <Step step={steps[1]}>
      <p>
        Shopazon is a
        <strong class="text-violet-400">NextJS ecommerce</strong> web
        application, hosted on <strong class="text-violet-400">Vercel</strong>,
        that provides a modern approach to
        <strong class="text-violet-400">online shopping</strong>. Includes features like an
        anonymous shopping cart and Google sign in. Shopping has never been this easy!
      </p>
    </Step>
  </section>
  <section
      ...
      <table class="bg-white text-slate-700 rounded text-center">
        ...
        <tbody class="">
          <tr class="border-b border-solid border-slate-200">
            <td
              class="whitespace-nowrap border-r border-solid border-white pl-4 pr-8 py-4 font-semibold text-sm"
              >Dedication</td
            >
